 ...
 */
final class Version20200621090430 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `like` (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, user_id INT NOT NULL, chapter_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_AC6340B316A2B381 (book_id), INDEX IDX_AC6340B3A76ED395 (user_id), INDEX IDX_AC6340B3579F4768 (chapter_id), INDEX IDX_AC6340B3F8697D13 (comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
